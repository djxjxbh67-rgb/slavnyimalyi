...
const services = [
  {
    ...
    color: "teal",
    description:
      "Коррекция речи у дошкольников: работа со звукопроизношением и общим недоразвитием речи (ОНР). Опытный специалист с\u00A0более чем 10-летним стажем. Индивидуальный подход и\u00A0консультации для родителей.",
    features: [
