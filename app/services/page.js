...
const services = [
  ...
  },
  {
    ...
    color: "sun",
    description:
      "Комплексная подготовка к\u00A0школе: чтение, грамота, математика. Формируем навыки будущего первоклассника в\u00A0дружелюбной атмосфере. Занятия по будням (2\u00A0раза в\u00A0неделю) или по\u00A0субботам.",
    features: [
      "Обучение чтению и грамоте",
      "Основы математики и счёта",
      "Развитие внимания и памяти",
      "Подготовка руки к письму",
      "Занятия по будням или субботам",
    ],
    prices: [
